...
|---|---|---|
| **ISO Image** | `drivewipe-live-v1.1.7.iso` | Write to USB with Rufus or `dd`. |
| **PXE Network** | `drivewipe-live-v1.1.7-pxe.tar.gz` | Dissected artifacts for network booting. |

## PXE Network Boot

For wiping entire racks without USB drives, use the `drivewipe-live-v1.1.7-pxe.tar.gz` archive. This provides a turnkey boot environment:
