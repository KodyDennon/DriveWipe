...
pub fn clone_partition_aware(
    ...
    let mut header_buf = vec![0u8; 34 * 512]; // Read enough for GPT header + entries
    ...
    super::block::clone_block(source, target, config, progress_tx, cancel_token)
}
